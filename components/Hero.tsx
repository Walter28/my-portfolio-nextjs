...
function Hero() {
  return (
    <div className='pb-20 pt-36'>
        <div>
            <Spotlight className='-top-40 -lef-10 md:-left-32 md:-top-20
            h-screen' fill='white' />
            <Spotlight className='top-10 lef-full h-[80vh] w-[50vw] ' fill='purple' />
            <Spotlight className='top-28 lef-10 h-[80vh] w-[50vw] ' fill='blue' />
        </div>
        ...
        <div className='flex justify-center relative my-20 z-10'>
          ...
          flex-col items-center justify-center'>
            ...
            <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
              Hi , I&apos;m MUHIRE Christian, a FullStuck Web Dev based in Goma DRC
            </p>
